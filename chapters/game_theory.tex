...
It is important to note that noncooperative doesn't always imply that the players are not competing \todo{Kan iemand even verifieren dat het zo goed is? (Dus that players are not competing ipv cooperating)}, it means that cooperations that arises must be self-enforcing with no communication or coordination of strategic choices among the players.\cite{keypaper}
...
\todo{Stukje over Stochastic games afmaken}
\subsubsection{Game of perfect information}
\todo{Stukje over Game of Perfect information afmaken}
