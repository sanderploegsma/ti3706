...
In the chapter \ac{em} we will look at the challenges in the generation, storage and transportion of energy with the use of \acp{vpp} and microgrids. \improve{\dots  transportion of energy and use \acp{vpp} and microgrids to do so.}
