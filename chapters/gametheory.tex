...
In Table \ref{prisoners-d} you can see all options for the prisoner's dilemma modelled in an easier to read payoff matrix. 
...
Microgrids can be seen as subsections of the smart grid. Since energy is saved by keeping produced energy inside its original microgrid, a lot of research is being done on game theory mechanisms that help a microgrid to be independent.
