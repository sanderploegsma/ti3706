...
It was not until recently, that researchers proved computing a Nash equilibrium is complete for the complexity class PPAD\cite{daskalakis2009complexity}. This means that deciding if a Nash equilibrium exists is a trivial question, as the answer of all PPAD problems is always yes, a solution always exists. Finding this solution though, cannot be NP-complete, as NP is a class of decision problems. But Daskalakis et al. informally suggest finding a Nash problem is ``as close to NP-complete as it could possibly be'' \cite{daskalakis2009complexity, Aaronson2012}. 
